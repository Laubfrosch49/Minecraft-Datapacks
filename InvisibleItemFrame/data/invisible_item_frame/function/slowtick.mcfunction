...
#Make visible
execute as @a at @s unless entity @s[nbt=!{SelectedItem:{id:"minecraft:soul_torch"}},nbt=!{Inventory:[{Slot:-106b,id:"minecraft:soul_torch"}]},nbt=!{SelectedItem:{id:"minecraft:soul_lantern"}},nbt=!{Inventory:[{Slot:-106b,id:"minecraft:soul_lantern"}]}] as @e[tag=InvisibleItemFrame,nbt={Invisible:1b}, distance=..5] at @s run particle minecraft:effect ~ ~ ~ 0.2 0.2 0.2 1 10 force @a
execute as @a at @s unless entity @s[nbt=!{SelectedItem:{id:"minecraft:soul_torch"}},nbt=!{Inventory:[{Slot:-106b,id:"minecraft:soul_torch"}]},nbt=!{SelectedItem:{id:"minecraft:soul_lantern"}},nbt=!{Inventory:[{Slot:-106b,id:"minecraft:soul_lantern"}]}] as @e[tag=InvisibleItemFrame,nbt={Invisible:1b}, distance=..5] run data modify entity @s Invisible set value 0b
